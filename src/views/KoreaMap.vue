<template>
  <div>
    <div class="map-wrapper">
      ...
      <icon-base iconName="koreaMap" viewBox="400 -50 1200 520" width="1920" height="1200">
    ...
    <div
      ...
      :key="province"
      class="province-point-wrapper"
    >
      <div class="point-inner">{{ province }} {{ count }}</div>
    </div>
  </div>
</template>
...
const resizingPage = () => {
  const resizeHandler = throttle(function () {
    ...
    if (pageWidth < 720) {
      svg?.setAttribute('viewBox', '350 0 600 800')
    } else {
